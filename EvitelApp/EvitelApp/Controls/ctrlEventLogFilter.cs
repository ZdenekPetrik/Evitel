...
namespace EvitelApp.Controls
{
    public partial class ctrlEventLogFilter : UserControl
    {
        ...
        public int filterEventGroup { get { return ((ComboItem)cmbEventGroup.SelectedItem).iValue; } }
        public int filterEventType { get { return ((ComboItem)cmbEventType.SelectedItem).iValue; } }
        ...
        private void ctrlEventLogFilter_Load(object sender, EventArgs e)
        {
            ...
            cmbEventGroup.Items.Add(new ComboItem("< ALL >", "-1"));
            foreach (State Any in EventType)
            {
                cmbEventGroup.Items.Add(new ComboItem(Any.DescriptionValue, Any.StateValue.ToString()));
            }
            cmbEventGroup.SelectedIndex = 0;

            cmbEventType.Items.Add(new ComboItem("< ALL >", "-1"));
            foreach (State Any in EventSubType)
            {
                cmbEventType.Items.Add(new ComboItem(Any.DescriptionValue, Any.StateValue.ToString()));
            }
